...
- 推荐 APK：Wtonec-v1.7.2-vc698-standard-universal-dual-host-release-hardened.apk
...
2. 两个公开仓库的 v1.7.2 Release 使用同一 Standard Universal Hardened APK。
